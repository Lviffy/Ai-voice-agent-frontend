  ...
  const benefits = [
    {
      ...
      description: "Handle 80% of routine inquiries automatically, freeing staff to focus on complex issues and strategic initiatives.",
      icon: (
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Experience measurable improvements in efficiency, satisfaction, and operational excellence
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center gap-8 px-8 py-4 bg-background rounded-xl border border-border">
