    ...
    <footer className="w-full py-16 px-6 md:px-12 border-t border-border bg-card">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          <div className="md:col-span-2 space-y-6">
            ...
            <p className="text-muted-foreground max-w-xs">
              AI-powered voice agent for seamless multilingual student and parent support in educational institutions.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Dashboard Demo</a></li>
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center text-muted-foreground text-sm">
          <div>© 2025 AI Voice Agent. All rights reserved.</div>
