              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input placeholder="Enter your password" className="pl-10 pr-10" type={showPassword ? 'text' : 'password'} {...field} />
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <input type="checkbox" id="remember" className="h-4 w-4 rounded border border-gray-300 text-primary focus:ring-2 focus:ring-primary" />
