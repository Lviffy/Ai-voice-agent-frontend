...
const HeroSection = ({ onVoiceAssistantClick }) => {
  ...
  return (
    <section id="home" className="relative w-full h-screen -mt-16 pt-16 flex flex-col items-center justify-start overflow-hidden bg-background">
      ...
      <div className="flex-1 flex items-center justify-center pt-8 -mt-10">
        <div
          className={`relative z-10 max-w-5xl mx-auto px-6 md:px-12 text-center space-y-8 transition-all duration-700 transform ${
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-medium tracking-tighter text-foreground leading-[1.1] space-y-2">
            ...
            <div className="whitespace-nowrap">
              for <span className="text-primary">Student & Parent Support</span>
            </div>
          </h1>

          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto text-balance leading-relaxed">
            Seamless, conversational solutions for education institutions. Our AI agent handles multilingual support, voice interactions, 24/7 service, context management, and privacy-focused
            conversations to streamline campus communications.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8 items-center">
            <Button
              onClick={() => {
                console.log('Voice Assistant button clicked') // ADD THIS
          ...
          <div className="pt-6 text-sm text-muted-foreground">24/7 Support • Multi-language Ready • Privacy Compliant</div>
        </div>
      </div>
    </section>
  )
